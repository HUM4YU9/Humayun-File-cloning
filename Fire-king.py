...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mMD HUM4YU9 KO31R
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801880480527
\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1mMD Humayun kobir
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/HUMAYUN.KOBIR.OFFICIAL.04")
		exit()
...
def setting():
	...
	if fast in ['y','Y']:
		...
		os.system("xdg-openhttps://www.facebook.com/HUMAYUN.KOBIR.OFFICIAL.04")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [HUM4YU9] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [HUM4YU9-CP] %s|%s        '%(b,idf,pw))
